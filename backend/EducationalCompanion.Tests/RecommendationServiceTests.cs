...
namespace EducationalCompanion.Tests;

public class RecommendationServiceTests
{
    private static Guid R1 = Guid.Parse("11111111-1111-1111-1111-111111111111");
    private static Guid R2 = Guid.Parse("22222222-2222-2222-2222-222222222222");
    ...
    public async Task CreateBatchForUserAsync_ThrowsWhenEmptyRecommendations()
    {
        ...
        var resourceRepo = new FakeLearningResourceRepository(resourcesById: new Dictionary<Guid, LearningResource>
        {
    ...
    private sealed class FakeUserProfileRepository : IUserProfileRepository
    {
        ...
        public FakeUserProfileRepository(bool hasUser)
        {
            _hasUser = hasUser;
        }
        ...
        {
            return Task.FromResult(_hasUser ? new UserProfile { UserId = userId } : null);
        }
